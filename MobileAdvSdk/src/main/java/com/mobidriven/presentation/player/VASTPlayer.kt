...
import com.mobidriven.exoplayer2.source.ProgressiveMediaSource
...
import com.mobidriven.exoplayer2.ui.StyledPlayerView
import com.mobidriven.presentation.player.model.TrackingEventsType
...
import com.mobidriven.presentation.player.util.VASTLog.d
import com.mobidriven.presentation.player.util.VASTLog.e
import com.mobidriven.presentation.player.util.VASTLog.i
import com.mobidriven.presentation.player.util.VASTLog.v
import com.mobidriven.presentation.player.util.VASTLog.w
import java.util.*
...
//            progressBar = mRoot?.findViewById<View>(R.id.progress) as ProgressBar
        ...
        if (simpleExoPlayer == null) {
            ...
            simpleExoPlayer?.addAnalyticsListener(object : AnalyticsListener {
                ...
                override fun onVideoSizeChanged(eventTime: AnalyticsListener.EventTime, videoSize: VideoSize) {
                    v(TAG, "onVideoSizeChanged -- ${videoSize.width} x ${videoSize.height}")
    ...
    fun refreshVolume() {
        if (mIsVideoMute) {
            turnVolumeOff()
            mMute?.setImageResource(R.drawable.ic_sound_off)
        } else {
            turnVolumeOn()
            mMute?.setImageResource(R.drawable.ic_sound_on)
        }
    }
