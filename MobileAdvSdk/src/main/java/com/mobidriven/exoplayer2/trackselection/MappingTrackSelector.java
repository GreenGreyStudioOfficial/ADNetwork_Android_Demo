...
public abstract class MappingTrackSelector extends TrackSelector {
  ...
  public final TrackSelectorResult selectTracks(
    ...
    Pair< RendererConfiguration[], ExoTrackSelection[]> result =
        selectTracks(
            mappedTrackInfo,
            rendererFormatSupports,
            rendererMixedMimeTypeAdaptationSupports,
   ...
   */
  protected abstract Pair< RendererConfiguration[],  ExoTrackSelection[]>
      selectTracks(
          MappedTrackInfo mappedTrackInfo,
          @Capabilities int[][][] rendererFormatSupports,
  ...
  /* package */ static TracksInfo buildTracksInfo(
      TrackSelection[] selections, MappedTrackInfo mappedTrackInfo) {
