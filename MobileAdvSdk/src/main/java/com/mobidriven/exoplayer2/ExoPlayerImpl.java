 ...
 */
package com.mobidriven.exoplayer2;

import static com.mobidriven.exoplayer2.C.TRACK_TYPE_AUDIO;
import static com.mobidriven.exoplayer2.C.TRACK_TYPE_CAMERA_MOTION;
import static com.mobidriven.exoplayer2.C.TRACK_TYPE_VIDEO;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_AUDIO_ATTRIBUTES;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_AUDIO_SESSION_ID;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_AUX_EFFECT_INFO;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_CAMERA_MOTION_LISTENER;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_CHANGE_FRAME_RATE_STRATEGY;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_SCALING_MODE;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_SKIP_SILENCE_ENABLED;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_VIDEO_FRAME_METADATA_LISTENER;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_VIDEO_OUTPUT;
import static com.mobidriven.exoplayer2.Renderer.MSG_SET_VOLUME;
import static com.mobidriven.exoplayer2.util.Assertions.checkNotNull;
import static com.mobidriven.exoplayer2.util.Assertions.checkState;
import static com.mobidriven.exoplayer2.util.Util.castNonNull;
...
import com.mobidriven.exoplayer2.PlayerMessage.Target;
import com.mobidriven.exoplayer2.Renderer.MessageType;
import com.mobidriven.exoplayer2.analytics.AnalyticsCollector;
import com.mobidriven.exoplayer2.analytics.AnalyticsListener;
import com.mobidriven.exoplayer2.analytics.PlayerId;
import com.mobidriven.exoplayer2.audio.AudioAttributes;
import com.mobidriven.exoplayer2.audio.AudioRendererEventListener;
import com.mobidriven.exoplayer2.audio.AuxEffectInfo;
import com.mobidriven.exoplayer2.decoder.DecoderCounters;
import com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation;
import com.mobidriven.exoplayer2.metadata.Metadata;
import com.mobidriven.exoplayer2.metadata.MetadataOutput;
import com.mobidriven.exoplayer2.source.MediaSource;
import com.mobidriven.exoplayer2.source.MediaSource.MediaPeriodId;
import com.mobidriven.exoplayer2.source.ShuffleOrder;
import com.mobidriven.exoplayer2.source.TrackGroup;
import com.mobidriven.exoplayer2.source.TrackGroupArray;
import com.mobidriven.exoplayer2.text.Cue;
import com.mobidriven.exoplayer2.text.TextOutput;
import com.mobidriven.exoplayer2.trackselection.ExoTrackSelection;
import com.mobidriven.exoplayer2.trackselection.TrackSelectionArray;
import com.mobidriven.exoplayer2.trackselection.TrackSelectionParameters;
import com.mobidriven.exoplayer2.trackselection.TrackSelector;
import com.mobidriven.exoplayer2.trackselection.TrackSelectorResult;
import com.mobidriven.exoplayer2.upstream.BandwidthMeter;
import com.mobidriven.exoplayer2.util.Assertions;
import com.mobidriven.exoplayer2.util.Clock;
import com.mobidriven.exoplayer2.util.ConditionVariable;
import com.mobidriven.exoplayer2.util.HandlerWrapper;
import com.mobidriven.exoplayer2.util.ListenerSet;
import com.mobidriven.exoplayer2.util.Log;
import com.mobidriven.exoplayer2.util.PriorityTaskManager;
import com.mobidriven.exoplayer2.util.Util;
import com.mobidriven.exoplayer2.video.VideoDecoderOutputBufferRenderer;
import com.mobidriven.exoplayer2.video.VideoFrameMetadataListener;
import com.mobidriven.exoplayer2.video.VideoRendererEventListener;
import com.mobidriven.exoplayer2.video.VideoSize;
import com.mobidriven.exoplayer2.video.spherical.CameraMotionListener;
import com.mobidriven.exoplayer2.video.spherical.SphericalGLSurfaceView;
