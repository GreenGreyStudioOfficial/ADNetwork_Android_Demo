  ...
  private static SparseArray<Constructor<? extends Downloader>> createDownloaderConstructors() {
    ...
    try {
      array.put(
          ...
          getDownloaderConstructor(
              Class.forName("com.mobileadvsdk.exoplayer2.source.dash.offline.DashDownloader")));
    ...
    try {
      array.put(
          C.TYPE_HLS,
          getDownloaderConstructor(
              Class.forName("com.mobileadvsdk.exoplayer2.source.hls.offline.HlsDownloader")));
    } catch (ClassNotFoundException e) {
    ...
    try {
      array.put(
          ...
          getDownloaderConstructor(
              Class.forName(
                  "com.mobileadvsdk.exoplayer2.source.smoothstreaming.offline.SsDownloader")));
    } catch (ClassNotFoundException e) {
