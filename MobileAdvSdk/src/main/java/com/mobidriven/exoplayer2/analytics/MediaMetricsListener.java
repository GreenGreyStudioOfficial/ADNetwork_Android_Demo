...
import com.mobidriven.exoplayer2.C.ContentType;
import com.mobidriven.exoplayer2.ExoPlaybackException;
import com.mobidriven.exoplayer2.ExoPlayerLibraryInfo;
...
import com.mobidriven.exoplayer2.upstream.FileDataSource;
import com.mobidriven.exoplayer2.upstream.HttpDataSource;
import com.mobidriven.exoplayer2.upstream.UdpDataSource;
import com.mobidriven.exoplayer2.util.NetworkTypeObserver;
  ...
  private void reportTrackChangeEvent(
    ...
    if (format != null) {
      ...
      if (format.language != null) {
        Pair<String, String> languageAndRegion =
