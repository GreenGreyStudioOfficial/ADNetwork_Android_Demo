...
import com.mobidriven.exoplayer2.database.DatabaseIOException;
import com.mobidriven.exoplayer2.database.DatabaseProvider;
import com.mobidriven.exoplayer2.database.VersionTable;
import com.mobidriven.exoplayer2.util.Assertions;
import com.mobidriven.exoplayer2.util.AtomicFile;
...
/* package */ class CachedContentIndex {
  ...
  private interface Storage {
     ...
     */
    void load(HashMap<String, CachedContent> content, SparseArray<  String> idToKey)
        throws IOException;
  ...
  private static class LegacyStorage implements Storage {
    ...
    @Override
    public void load(
        HashMap<String, CachedContent> content, SparseArray<  String> idToKey) {
      checkState(!changed);
