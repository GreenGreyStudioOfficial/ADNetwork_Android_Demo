...
import static com.mobidriven.exoplayer2.util.MimeTypes.getMimeTypeFromMp4ObjectType;
...
import com.mobidriven.exoplayer2.audio.OpusUtil;
import com.mobidriven.exoplayer2.drm.DrmInitData;
import com.mobidriven.exoplayer2.extractor.ExtractorUtil;
import com.mobidriven.exoplayer2.extractor.GaplessInfoHolder;
import com.mobidriven.exoplayer2.metadata.Metadata;
import com.mobidriven.exoplayer2.metadata.mp4.SmtaMetadataEntry;
import com.mobidriven.exoplayer2.util.CodecSpecificDataUtil;
...
/* package */ final class AtomParsers {
     ...
     */
    public static Pair< Metadata,  Metadata> parseUdta(
    ...
    private static void parseVideoSampleEntry(
        ...
        while (childPosition - position < size) {
            ...
            if (childAtomType == Atom.TYPE_avcC) {
                ...
                ExtractorUtil.checkContainerInput(mimeType == null, /* message= */ null);
                Pair<  String, byte   []> mimeTypeAndInitializationDataBytes =
     ...
     */
    private static Pair< String, byte  []> parseEsdsFromParent(
