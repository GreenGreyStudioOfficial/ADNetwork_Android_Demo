...
import com.mobidriven.exoplayer2.audio.AudioCapabilities;
import com.mobidriven.exoplayer2.audio.AudioRendererEventListener;
import com.mobidriven.exoplayer2.audio.AudioSink;
import com.mobidriven.exoplayer2.audio.DefaultAudioSink;
import com.mobidriven.exoplayer2.audio.MediaCodecAudioRenderer;
import com.mobidriven.exoplayer2.mediacodec.DefaultMediaCodecAdapterFactory;
import com.mobidriven.exoplayer2.mediacodec.MediaCodecAdapter;
import com.mobidriven.exoplayer2.mediacodec.MediaCodecSelector;
import com.mobidriven.exoplayer2.metadata.MetadataOutput;
import com.mobidriven.exoplayer2.metadata.MetadataRenderer;
import com.mobidriven.exoplayer2.text.TextOutput;
import com.mobidriven.exoplayer2.text.TextRenderer;
import com.mobidriven.exoplayer2.trackselection.TrackSelector;
import com.mobidriven.exoplayer2.util.Log;
import com.mobidriven.exoplayer2.video.MediaCodecVideoRenderer;
import com.mobidriven.exoplayer2.video.VideoRendererEventListener;
import com.mobidriven.exoplayer2.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  /**
   * Enables {@link com.mobidriven.exoplayer2.mediacodec.MediaCodecRenderer} instances to
  ...
  /**
   * Disables {@link com.mobidriven.exoplayer2.mediacodec.MediaCodecRenderer} instances from
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      Class<?> clazz = Class.forName("com.mobileadvsdk.exoplayer2.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
              com.mobidriven.exoplayer2.video.VideoRendererEventListener.class,
              int.class);
      Renderer renderer =
          (Renderer)
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.mobileadvsdk.exoplayer2.ext.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.mobileadvsdk.exoplayer2.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.mobidriven.exoplayer2.audio.AudioRendererEventListener.class,
              com.mobidriven.exoplayer2.audio.AudioSink.class);
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.mobileadvsdk.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.mobidriven.exoplayer2.audio.AudioRendererEventListener.class,
   ...
   * com.mobidriven.exoplayer2.mediacodec.MediaCodecRenderer} instances.
   */
