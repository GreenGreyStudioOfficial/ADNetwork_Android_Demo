 ...
 */
package com.mobidriven.exoplayer2.mediacodec;

import static com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_DRM_SESSION_CHANGED;
import static com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_OPERATING_RATE_CHANGED;
import static com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_REUSE_NOT_IMPLEMENTED;
import static com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_WORKAROUND;
import static com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.REUSE_RESULT_NO;
import static com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITHOUT_RECONFIGURATION;
import static com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_FLUSH;
import static com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_RECONFIGURATION;
import static com.mobidriven.exoplayer2.source.SampleStream.FLAG_OMIT_SAMPLE_DATA;
import static com.mobidriven.exoplayer2.source.SampleStream.FLAG_PEEK;
import static com.mobidriven.exoplayer2.source.SampleStream.FLAG_REQUIRE_FORMAT;
...
import com.mobidriven.exoplayer2.BaseRenderer;
import com.mobidriven.exoplayer2.C;
import com.mobidriven.exoplayer2.ExoPlaybackException;
import com.mobidriven.exoplayer2.Format;
import com.mobidriven.exoplayer2.FormatHolder;
import com.mobidriven.exoplayer2.PlaybackException;
import com.mobidriven.exoplayer2.analytics.PlayerId;
import com.mobidriven.exoplayer2.decoder.CryptoConfig;
import com.mobidriven.exoplayer2.decoder.DecoderCounters;
import com.mobidriven.exoplayer2.decoder.DecoderInputBuffer;
import com.mobidriven.exoplayer2.decoder.DecoderInputBuffer.InsufficientCapacityException;
import com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation;
import com.mobidriven.exoplayer2.decoder.DecoderReuseEvaluation.DecoderDiscardReasons;
import com.mobidriven.exoplayer2.drm.DrmSession;
import com.mobidriven.exoplayer2.drm.DrmSession.DrmSessionException;
import com.mobidriven.exoplayer2.drm.FrameworkCryptoConfig;
import com.mobidriven.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException;
import com.mobidriven.exoplayer2.source.MediaPeriod;
import com.mobidriven.exoplayer2.source.SampleStream;
import com.mobidriven.exoplayer2.source.SampleStream.ReadDataResult;
import com.mobidriven.exoplayer2.source.SampleStream.ReadFlags;
import com.mobidriven.exoplayer2.util.Assertions;
import com.mobidriven.exoplayer2.util.Log;
import com.mobidriven.exoplayer2.util.MimeTypes;
import com.mobidriven.exoplayer2.util.NalUnitUtil;
import com.mobidriven.exoplayer2.util.TimedValueQueue;
import com.mobidriven.exoplayer2.util.TraceUtil;
