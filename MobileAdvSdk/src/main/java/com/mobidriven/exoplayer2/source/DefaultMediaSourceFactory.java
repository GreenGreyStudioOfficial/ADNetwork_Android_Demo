...
import static com.mobidriven.exoplayer2.util.Assertions.checkStateNotNull;
...
import com.mobidriven.exoplayer2.drm.DrmSessionManagerProvider;
import com.mobidriven.exoplayer2.extractor.DefaultExtractorsFactory;
import com.mobidriven.exoplayer2.extractor.Extractor;
import com.mobidriven.exoplayer2.extractor.ExtractorInput;
...
import com.mobidriven.exoplayer2.source.ads.AdsLoader;
import com.mobidriven.exoplayer2.source.ads.AdsMediaSource;
import com.mobidriven.exoplayer2.text.SubtitleDecoderFactory;
import com.mobidriven.exoplayer2.text.SubtitleExtractor;
import com.mobidriven.exoplayer2.ui.AdViewProvider;
import com.mobidriven.exoplayer2.upstream.DataSource;
import com.mobidriven.exoplayer2.upstream.DataSpec;
import com.mobidriven.exoplayer2.upstream.DefaultDataSource;
...
//    private final Map<Integer,   Supplier<MediaSource.Factory>>
    private final Map<Integer, Supplier<MediaSource.Factory>>
    ...
    private Supplier<MediaSource.Factory> maybeLoadSupplier(@C.ContentType int contentType) {
      ...
      try {
        ...
        switch (contentType) {
          case C.TYPE_DASH:
            clazz =
                Class.forName("com.mobileadvsdk.exoplayer2.source.dash.DashMediaSource$Factory")
          ...
          case C.TYPE_SS:
            clazz =
                Class.forName(
                        "com.mobileadvsdk.exoplayer2.source.smoothstreaming.SsMediaSource$Factory")
                    .asSubclass(MediaSource.Factory.class);
            mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
            break;
          case C.TYPE_HLS:
            clazz =
                Class.forName("com.mobileadvsdk.exoplayer2.source.hls.HlsMediaSource$Factory")
                    .asSubclass(MediaSource.Factory.class);
            mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
            break;
          case C.TYPE_RTSP:
            clazz =
                Class.forName("com.mobileadvsdk.exoplayer2.source.rtsp.RtspMediaSource$Factory")
                    .asSubclass(MediaSource.Factory.class);
